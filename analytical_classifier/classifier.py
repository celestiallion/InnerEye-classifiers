...
model_name = 'Model_V1-{epoch:02d}-{val_predictions_categorical_accuracy:.4f}.h5'
...
csv_logger = callbacks.CSVLogger(os.path.join(save_dir, 'Log_V1.log'), separator=',', append=False)
